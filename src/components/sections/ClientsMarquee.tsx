...
const clients = [
  ...
  { name: 'PT. Aulia Cosmetic Indonesia',  domain: 'auliacosmetic.com',     color: '#b5006e' },
  ...
  { name: 'PT. Primasid Andalan Utama',    domain: 'primasid.com',          color: '#c44a15' },
  ...
  { name: 'PT. Escalier Indonesia',        domain: 'escalier.co.id',        color: '#1a5fa0' },
  ...
  { name: 'PT. Sahabat Jaya Solusindo',    domain: 'sahabatjaya.co.id',     color: '#0e8a6e' },
  ...
  { name: 'Sekolah Tiara Kasih',           domain: 'tiarakasih.sch.id',     color: '#b5720a' },
  { name: 'GKI Cinere',                    domain: 'gkicinere.org',          color: '#8e44ad' },
  { name: 'PT. Visiotek Global',           domain: 'visiotek.co.id',         color: '#2471a3' },
  { name: 'Tak Prime',                     domain: 'takprime.co.id',         color: '#1a252f' },
  { name: 'Toyota Astra Finance',          domain: 'toyotafinance.co.id',    color: '#eb0a1e' },
  { name: 'PT. Intertrans Global Logistics', domain: 'intertrans.co.id',     color: '#1f618d' },
  { name: 'PT. Gurita Lintas Samudera',    domain: 'guritals.co.id',         color: '#117a65' },
  { name: 'PT. Bogasari',                  domain: 'bogasari.com',           color: '#a85a10' },
