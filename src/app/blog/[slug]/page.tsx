...
const posts: Record<string, Post> = {
  ...
  '10-ide-team-building-kreatif': {
    ...
    content: [
      { type: 'intro', text: 'Team building yang efektif bukan sekadar kumpul-kumpul. Program yang dirancang dengan baik dapat meningkatkan produktivitas tim hingga 25%. Berikut 10 ide yang bisa langsung dieksekusi!' },
      { type: 'h2', text: '1. 🚀 Amazing Race Kota' }, { type: 'p', text: 'Jadikan kota sebagai arena permainan! Tim berlomba menyelesaikan misi di berbagai titik dengan clue yang mengasyikkan.' },
      { type: 'h2', text: '2. 🍳 Cooking Battle' }, { type: 'p', text: 'Memasak bersama melatih delegasi tugas, time management, dan menciptakan kenangan menyenangkan.' },
      { type: 'h2', text: '3. 🎨 Mural Bersama' }, { type: 'p', text: 'Ciptakan karya seni kolektif yang bisa dipajang di kantor sebagai simbol kebersamaan.' },
      { type: 'h2', text: '4. 🌱 Pertanian & Kebun Urban' }, { type: 'p', text: 'Farm-to-table: tim berkebun, memanen, lalu memasak dan menikmati hasilnya bersama.' },
      { type: 'h2', text: '5. 🎤 Stand-Up Comedy Workshop' }, { type: 'p', text: 'Melatih public speaking, kepercayaan diri, dan keberanian untuk tertawa bersama rekan kerja.' },
      { type: 'h2', text: '6. 🏆 Game Show Internal' }, { type: 'p', text: 'Rancang versi perusahaan dari game show favorit — kuis produk, tebak gambar, atau mimik wajah.' },
      { type: 'h2', text: '7. 🎯 Paintball & Airsoft' }, { type: 'p', text: 'Aktivitas penuh adrenalin yang melatih strategi tim dan komunikasi lapangan.' },
      { type: 'h2', text: '8. 🛶 Arung Jeram (Rafting)' }, { type: 'p', text: 'Hadapi tantangan arus sungai bersama — melatih sinkronisasi tim dan kepercayaan satu sama lain.' },
      { type: 'h2', text: '9. 🌄 Trekking & Hiking' }, { type: 'p', text: 'Perjalanan mendaki membangun mentalitas "tidak ada yang ditinggal" dan kebersamaan.' },
      { type: 'h2', text: '10. ❤️ Charity Challenge' }, { type: 'p', text: 'Gabungkan team building dengan aksi sosial — membangun empati dan kebanggaan bersama.' },
      { type: 'tip', text: 'Tim Sarau Luxury siap membantu mengeksekusi salah satu ide di atas! Hubungi kami untuk program team building yang sempurna.' },
    ],
  },
  'destinasi-outing-terbaik-jawa-bali': {
    ...
    content: [
      { type: 'intro', text: 'Memilih destinasi outing yang tepat adalah kunci suksesnya sebuah event. Berikut rekomendasi terbaik berdasarkan pengalaman ratusan event.' },
      { type: 'h2', text: '🏔️ Lembang & Bandung Utara' }, { type: 'p', text: 'Udara sejuk, pemandangan indah, dan jarak terjangkau dari Jakarta. Cocok untuk gathering 1-3 hari dengan anggaran menengah.' },
      { type: 'ul', items: ['Banyak villa dan resort kapasitas besar', 'Aktivitas: outbound, paintball, offroad', 'Harga terjangkau dibanding Bali'] },
      { type: 'h2', text: '🌊 Anyer & Carita, Banten' }, { type: 'p', text: 'Pantai terdekat dari Jakarta dengan view Selat Sunda. Ideal untuk team building outdoor dan water sport.' },
      { type: 'h2', text: '🏝️ Bali' }, { type: 'p', text: 'Destinasi premium yang selalu memukau. Ubud untuk budaya, Nusa Dua untuk resort mewah.' },
      { type: 'h2', text: '🌋 Bromo & Malang, Jawa Timur' }, { type: 'p', text: 'Sunrise di Gunung Bromo adalah pengalaman tak terlupakan. Cocok untuk tim yang suka petualangan.' },
      { type: 'h2', text: '🌿 Yogyakarta' }, { type: 'p', text: 'Kota budaya yang kaya sejarah — Borobudur, Prambanan, dan kuliner legendaris.' },
      { type: 'quote', text: 'Destinasi terbaik adalah yang sesuai dengan karakter tim Anda, bukan yang paling viral.' },
      { type: 'tip', text: 'Konsultasikan kebutuhan destinasi Anda dengan tim Sarau Luxury. Kami rekomendasikan sesuai budget dan tujuan event!' },
    ],
  },
  'perbedaan-outing-outbound': {
    ...
    content: [
      { type: 'intro', text: 'Sering bingung bedanya outing dan outbound? Banyak HR yang masih keliru menggunakan kedua istilah ini. Keduanya punya tujuan, metode, dan hasil yang berbeda.' },
      { type: 'h2', text: '🏖️ Apa itu Outing?' }, { type: 'p', text: 'Outing adalah perjalanan bersama tim ke destinasi dengan tujuan relaksasi, bonding, dan refreshing.' },
      { type: 'ul', items: ['Tujuan: Refreshing, reward, keakraban', 'Aktivitas: Wisata, makan bersama, games ringan', 'Cocok untuk: Akhir tahun, reward karyawan'] },
      { type: 'h2', text: '🏋️ Apa itu Outbound?' }, { type: 'p', text: 'Outbound adalah program terstruktur untuk mengembangkan kompetensi spesifik melalui aktivitas outdoor yang dirancang khusus.' },
      { type: 'ul', items: ['Tujuan: Pengembangan kompetensi tim terukur', 'Aktivitas: Simulasi, permainan edukatif, tantangan fisik', 'Cocok untuk: Onboarding, problem tim, peningkatan performa'] },
      { type: 'h2', text: '🤷 Mana yang Harus Dipilih?' },
      { type: 'ol', items: ['Pilih Outing jika: Tim solid, butuh refreshing setelah kerja keras', 'Pilih Outbound jika: Ada masalah komunikasi atau konflik antar divisi', 'Pilih Gabungan: Outbound pagi + outing sore — paling efektif!'] },
      { type: 'tip', text: 'Konsultasikan dengan Sarau Luxury — kami bantu analisis kebutuhan tim dan rekomendasikan program yang tepat.' },
    ],
  },
